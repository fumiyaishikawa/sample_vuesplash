...
class PhotoSubmitApiTest extends TestCase
{
    ...
    public function should_ファイルをアップロードできる() {
        ...
        // -> storage/framework/testingにデータが保存される、指定しなければlocalフォルダ
        Storage::fake('s3');    //テスト後にファイルは削除される
    ...
    /**
     *  @test
     * データベースとの通信でエラーが発生したときにファイルが保存されないこと、3つめのテストケースはファイル保存でエラーが発生したときにデータが登録されないことを確認
     */
